# Appeagle OpenAPI Specification
[![Build Status](https://travis-ci.org/eric-appeagle/appeagle-redoc-demo.svg?branch=master)](https://travis-ci.org/eric-appeagle/appeagle-redoc-demo)
...
6. If you did everything correct, https://eric-appeagle.github.io/appeagle-redoc-demo/ will lead to your new docs
...
- Documentation(ReDoc): https://eric-appeagle.github.io/appeagle-redoc-demo/
- SwaggerUI: https://eric-appeagle.github.io/appeagle-redoc-demo/swagger-ui/
- Look full spec:
    + JSON https://eric-appeagle.github.io/appeagle-redoc-demo/swagger.json
    + YAML https://eric-appeagle.github.io/appeagle-redoc-demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://eric-appeagle.github.io/appeagle-redoc-demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://eric-appeagle.github.io/appeagle-redoc-demo/ with url from the message: `Server started <url>`
